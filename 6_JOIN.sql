...
/*
1. Modify it to show the matchid and player name for all 
...
/*
3. Modify it to show the player, teamid, stadium and 
   mdate for every German goal.
*/
...
/*
5. Show player, teamid, coach, gtime for all goals 
...
/*
6. List the dates of the matches and the name of the 
...
/*
8. Instead show the name of all players who scored a 
...
/*
10. Show the stadium and the number of goals scored 
   in each stadium. 
*/
...
/*
13. List every match with the goals scored by each 
   team as shown. This will use "CASE WHEN" which has 
