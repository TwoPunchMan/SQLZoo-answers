...
The next questions are optional and only for students who are 
finding the basic questions too easy. 
*/
...
/*
13. Find the capital and the name where the capital includes the 
   name of the country.
*/
...
SELECT name, REPLACE(capital, name, '') extension FROM world
WHERE capital LIKE CONCAT('%', name, '_%')
