...
/*
5. Show the name and the population of each country in 
...
/*
6. Which countries have a GDP greater than every country in 
   Europe? [Give the name only.] (Some countries may have 
   NULL gdp values) 
*/
...
9. Find the continents where all countries have a 
   ...
   countries associated with these continents. Show name,  
